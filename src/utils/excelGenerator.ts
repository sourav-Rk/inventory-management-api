...
// export const generateExcel = async (res: Response, title: string, data: any[], columns: string[]) => {
//   const workbook = new ExcelJS.Workbook();
//   const worksheet = workbook.addWorksheet("Report");

//   worksheet.columns = columns.map((col) => ({ header: col, key: col.toLowerCase(), width: 20 }));
...
//     currentRow++; // empty line after summary
//   }
...
//   /* ---------- DATA ROWS ---------- */
//   data.forEach((row) => {
//     const excelRow = worksheet.addRow(currentRow, row);
